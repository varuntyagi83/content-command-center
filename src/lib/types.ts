...
export function getProductColor(product: string) {
  switch (product) {
    case "Voltic": return { bg: "#6366f120", text: "#818cf8" };
    case "AdForge": return { bg: "#f59e0b20", text: "#fbbf24" };
    case "AI Catalyst": return { bg: "#10b98120", text: "#34d399" };
